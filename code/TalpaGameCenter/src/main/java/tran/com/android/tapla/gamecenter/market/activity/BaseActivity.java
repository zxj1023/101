 ...
 * @version V1.0
 */
package tran.com.android.tapla.gamecenter.market.activity;
	...
	/*private void openNetDialog()
	{
		...
		if (isDisconnect) {
			...
			AuroraAlertDialog mWifiConDialog = new AuroraAlertDialog.Builder(
					BaseActivity.this, AuroraAlertDialog.THEME_AMIGO_FULLSCREEN)
					.setTitle(
					...
					.setPositiveButton(android.R.string.ok,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									ed1.commit();
									Intent networkChange = new Intent(BaseActivity.this, AppDownloadService.class);
									networkChange.putExtra(AppDownloadService.DOWNLOAD_OPERATION,
											AppDownloadService.OPERATION_NETWORK_MOBILE_CONTINUE);
									BaseActivity.this.startService(networkChange);
								}
