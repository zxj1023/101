...
public class DetailProgressBtn extends LinearLayout {
    ...
    public static final int STATUS_DOWNLOAD_FAIL = 8; //下载失败
    public static final int STAUTS_DOWNLOAD_CONTINUE = 9; //暂停下载
    public static final int STAUTS_UPDATELING = 10; //正在更新
    public static final int STAUTS_A_KEY_UPDATE = 11; //一键更新
    ...
    public DetailProgressBtn(Context context) {
        super(context);
        initView();
    }

    public DetailProgressBtn(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
    @Override
    ...
    private void initView() {
        ...
        View view = inflater.inflate(R.layout.view_detail_progressbtn, this);
    ...
    public void setStatus(int status) {
        ...
        switch (status) {
            case STATUS_NORMAL:
                progressBar.setProgressDrawable(getContext().getDrawable(R.drawable.layer_list_detail_download_btn_df));
                progressText.setTextColor(Color.WHITE);
                progressText.setText(getContext().getString(R.string.download_button_download));
                break;
            case STATUS_WAIT_DOWNLOAD:
                progressBar.setProgressDrawable(getContext().getDrawable(R.drawable.layer_list_detail_download_btn_pase));
            ...
            case STATUS_PROGRESSING_DOWNLOAD:
                progressBar.setProgressDrawable(getContext().getDrawable(R.drawable.layer_list_detail_download_btn_downloading));
                if (progressText.getVisibility() == View.GONE) {
                    progressText.setVisibility(View.VISIBLE);
                }
                progressText.setTextColor(Color.WHITE);
            ...
            case STATUS_WAIT_INSTALL:
                ...
                progressText.setTextColor(waitingColor);
                progressText.setText(getContext().getString(R.string.download_button_wait));
                // shadow.setBackgroundResource(R.drawable.layer_list_download_btn_shadow_white);
                break;
            ...
            case STAUTS_DOWNLOAD_CONTINUE:
                ...
                // shadow.setBackgroundResource(R.drawable.layer_list_download_btn_shadow_white);
                break;
            case STAUTS_UPDATELING:
                progressBar.setProgressDrawable(getContext().getDrawable(R.drawable.layer_list_detail_download_btn_pase));
                progressText.setTextColor(waitingColor);
                progressText.setText(getContext().getString(R.string.update_button_updateing));
//                progressBar.setProgress(progress);
                if (progressText.getVisibility() == View.GONE) {
                    progressText.setVisibility(View.VISIBLE);
                }
//                progressText.setText(this.progress + getContext().getString(R.string.download_button_download_percent));
                break;
            case STAUTS_A_KEY_UPDATE:
                progressBar.setProgressDrawable(getContext().getDrawable(R.drawable.layer_list_detail_download_btn_df));
                progressText.setTextColor(Color.WHITE);
                if(/*TextUtils.isEmpty(allSize)*/allSize==0){
                    progressText.setText(getContext().getString(R.string.update_by_one_key));
                }else{
                    progressText.setText(getContext().getString(R.string.update_by_one_key)
                            + Config.LEFT_PARENTHESIS+allSize+"M"+Config.RIGHT_PARENTHESIS);
                }
