...
import tran.com.android.tapla.gamecenter.market.activity.fragment.PicViewFragment;
import tran.com.android.tapla.gamecenter.market.ui.PicViewPager;
import tran.com.android.tapla.gamecenter.market.ui.UploadProgressDialog;
...
public class PictureViewActivity extends FragmentActivity implements
	...
	private void setAdapter() {
		...
		paramsMargin.setMargins(0, 0, marginRight, /*10*/DensityUtil.dip2px(this,16));
		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.WRAP_CONTENT,
				LinearLayout.LayoutParams.WRAP_CONTENT);
		params.setMargins(0, 0, 0, DensityUtil.dip2px(this,16)/*10*/);
