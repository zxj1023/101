...
public class ImageViewAware extends ViewAware {
	...
	@Override
	public universalimageloader.core.assist.ViewScaleType getScaleType() {
		ImageView imageView = (ImageView) viewRef.get();
		if (imageView != null) {
			return universalimageloader.core.assist.ViewScaleType.fromImageView(imageView);
		}
	...
	private static int getImageViewFieldValue(Object object, String fieldName) {
		...
		try {
			...
			universalimageloader.utils.L.e(e);
		}
		return value;
	}
}
