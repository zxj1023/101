 ...
 *******************************************************************************/
package universalimageloader.core.imageaware;
...
public class NonViewAware implements ImageAware {
	...
	protected final universalimageloader.core.assist.ImageSize imageSize;
	protected final ViewScaleType scaleType;

	public NonViewAware(universalimageloader.core.assist.ImageSize imageSize, ViewScaleType scaleType) {
		this(null, imageSize, scaleType);
	}

	public NonViewAware(String imageUri, universalimageloader.core.assist.ImageSize imageSize, ViewScaleType scaleType) {
