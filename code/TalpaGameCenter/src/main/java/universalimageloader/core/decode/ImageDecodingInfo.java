...
public class ImageDecodingInfo {
	...
	private final universalimageloader.core.assist.ImageSize targetSize;

	private final universalimageloader.core.assist.ImageScaleType imageScaleType;
	private final ViewScaleType viewScaleType;

	private final universalimageloader.core.download.ImageDownloader downloader;
	private final Object extraForDownloader;

	private final boolean considerExifParams;
	private final Options decodingOptions;

	public ImageDecodingInfo(String imageKey, String imageUri, String originalImageUri, universalimageloader.core.assist.ImageSize targetSize, ViewScaleType viewScaleType,
                             universalimageloader.core.download.ImageDownloader downloader, universalimageloader.core.DisplayImageOptions displayOptions) {
	...
	/** @return Original {@linkplain MemoryCacheUtils#generateKey(String, universalimageloader.core.assist.ImageSize) image key} (used in memory cache). */
	...
	/**
	 * @return Target size for image. Decoded bitmap should close to this size according to {@linkplain universalimageloader.core.assist.ImageScaleType
	 * image scale type} and {@linkplain ViewScaleType view scale type}.
	 */
	public universalimageloader.core.assist.ImageSize getTargetSize() {
		return targetSize;
	}

	/**
	 * @return {@linkplain universalimageloader.core.assist.ImageScaleType Scale type for image sampling and scaling}. This parameter affects result size
	 * of decoded bitmap.
	 */
	...
	public universalimageloader.core.download.ImageDownloader getDownloader() {
		return downloader;
	}
