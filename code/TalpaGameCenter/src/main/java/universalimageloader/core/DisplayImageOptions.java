...
import universalimageloader.core.process.BitmapProcessor;
 ...
 * <li>auxiliary object which will be passed to {@link universalimageloader.core.download.ImageDownloader#getStream(String, Object) ImageDownloader}</li>
...
public final class DisplayImageOptions {
	...
	private final universalimageloader.core.assist.ImageScaleType imageScaleType;
	...
	public universalimageloader.core.assist.ImageScaleType getImageScaleType() {
	...
	public static class Builder {
		...
		private universalimageloader.core.assist.ImageScaleType imageScaleType = universalimageloader.core.assist.ImageScaleType.IN_SAMPLE_POWER_OF_2;
		...
		/**
		 * Sets {@linkplain universalimageloader.core.assist.ImageScaleType scale type} for decoding image. This parameter is used while define scale
		 * size for decoding image to Bitmap. Default value - {@link universalimageloader.core.assist.ImageScaleType#IN_SAMPLE_POWER_OF_2}
		 */
		public Builder imageScaleType(universalimageloader.core.assist.ImageScaleType imageScaleType) {
		 ...
		 * calculate the most appropriate sample size itself according yo {@link #imageScaleType(universalimageloader.core.assist.ImageScaleType)}
		 * options.<br />
		...
		/** Sets auxiliary object which will be passed to {@link universalimageloader.core.download.ImageDownloader#getStream(String, Object)} */
	 ...
	 * <li>{@link universalimageloader.core.assist.ImageScaleType#IN_SAMPLE_POWER_OF_2} decoding type will be used</li>
