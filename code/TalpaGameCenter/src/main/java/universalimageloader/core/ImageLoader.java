...
import universalimageloader.cache.memory.MemoryCache;

import universalimageloader.core.assist.FailReason;
import universalimageloader.core.assist.FlushedInputStream;
import universalimageloader.core.assist.ImageSize;
import universalimageloader.core.assist.LoadedFrom;
import universalimageloader.core.assist.ViewScaleType;
import universalimageloader.core.imageaware.ImageAware;
import universalimageloader.core.imageaware.ImageViewAware;
import universalimageloader.core.imageaware.NonViewAware;
 ...
 * <b>NOTE:</b> {@link #init(universalimageloader.core.ImageLoaderConfiguration)} method must be called before any other method.
 *
...
public class ImageLoader {
	...
	private universalimageloader.core.ImageLoaderConfiguration configuration;
	 ...
	 *
	 * @param configuration {@linkplain universalimageloader.core.ImageLoaderConfiguration ImageLoader configuration}
	 * @throws IllegalArgumentException if <b>configuration</b> parameter is null
	 */
	public synchronized void init(universalimageloader.core.ImageLoaderConfiguration configuration) {
	...
	/**
	 * Returns <b>true</b> - if ImageLoader {@linkplain #init(universalimageloader.core.ImageLoaderConfiguration) is initialized with
	 ...
	 * Default {@linkplain universalimageloader.core.DisplayImageOptions display image options} from {@linkplain universalimageloader.core.ImageLoaderConfiguration
	 * configuration} will be used.<br />
	 * <b>NOTE:</b> {@link #init(universalimageloader.core.ImageLoaderConfiguration)} method must be called before this method call
	 *
	 * @param uri        Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param imageAware {@linkplain ImageAware Image aware view}
	 *                   which should display image
	 * @throws IllegalStateException    if {@link #init(universalimageloader.core.ImageLoaderConfiguration)} method wasn't called before
	 ...
	 *                   {@linkplain universalimageloader.core.ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(universalimageloader.core.DisplayImageOptions)
	 *                   from configuration} will be used.
	 * @throws IllegalStateException    if {@link #init(universalimageloader.core.ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	public void displayImage(String uri, ImageAware imageAware, universalimageloader.core.DisplayImageOptions options) {
	...
	public void displayImage(String uri, ImageAware imageAware, universalimageloader.core.DisplayImageOptions options,
		...
		ImageSize targetSize = universalimageloader.utils.ImageSizeUtils.defineTargetSizeForView(imageAware, configuration.getMaxImageSize());
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			if (options.shouldPostProcess()) {
				universalimageloader.core.ImageLoadingInfo imageLoadingInfo = new universalimageloader.core.ImageLoadingInfo(uri, imageAware, targetSize, memoryCacheKey,
	...
	public void displayImage1(String uri, ImageAware imageAware, universalimageloader.core.DisplayImageOptions options,
			ImageLoadingListener listener, ImageLoadingProgressListener progressListener,Context context,int type) {
		checkConfiguration();
		if (imageAware == null) {
			throw new IllegalArgumentException(ERROR_WRONG_ARGUMENTS);
		}
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			L.d(LOG_LOAD_IMAGE_FROM_MEMORY_CACHE, 11111);
			if (options.shouldShowImageOnLoading()) {
				imageAware.setImageDrawable(options.getImageOnLoading(configuration.resources));
			} else if (options.isResetViewBeforeLoading()) {
				imageAware.setImageDrawable(null);
			...
			universalimageloader.core.ImageLoadingInfo imageLoadingInfo = new universalimageloader.core.ImageLoadingInfo(uri, imageAware, targetSize, memoryCacheKey,
					options, listener, progressListener, engine.getLockForUri(uri));
			LoadAndDisplayImageTask displayTask = new LoadAndDisplayImageTask(engine, imageLoadingInfo,
					defineHandler(options),context,type);
			if (options.isSyncLoading()) {
				displayTask.run();
			} else {
				engine.submit(displayTask);
	 ...
	 * @throws IllegalArgumentException if passed <b>imageView</b> is null
	 */
	public void displayImage(String uri, ImageView imageView, universalimageloader.core.DisplayImageOptions options) {
	 ...
	 * @param options  {@linkplain universalimageloader.core.DisplayImageOptions Options} for image
	 *                 decoding and displaying. If <b>null</b> - default display image options
	 *                 {@linkplain universalimageloader.core.ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(universalimageloader.core.DisplayImageOptions) from
	 *                 configuration} will be used.<br />
	 * @param listener {@linkplain ImageLoadingListener Listener} for image loading process. Listener fires events on UI
	 *                 thread if this method is called on UI thread.
	 * @throws IllegalStateException if {@link #init(universalimageloader.core.ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri, universalimageloader.core.DisplayImageOptions options, ImageLoadingListener listener) {
	 ...
	 * @throws IllegalStateException if {@link #init(universalimageloader.core.ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri, ImageSize targetImageSize, universalimageloader.core.DisplayImageOptions options,
			ImageLoadingListener listener) {
	 ...
	 * @throws IllegalStateException if {@link #init(universalimageloader.core.ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri, universalimageloader.core.DisplayImageOptions options) {
	 ...
	 * @throws IllegalStateException if {@link #init(universalimageloader.core.ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri, ImageSize targetImageSize, universalimageloader.core.DisplayImageOptions options) {
		if (options == null) {
			options = configuration.defaultDisplayImageOptions;
		}
		options = new universalimageloader.core.DisplayImageOptions.Builder().cloneFrom(options).syncLoading(true).build();
	 ...
	 */
	@Deprecated
	public universalimageloader.cache.disc.DiskCache getDiscCache() {
		return getDiskCache();
	}
	 ...
	 * @throws IllegalStateException if {@link #init(universalimageloader.core.ImageLoaderConfiguration)} method wasn't called before
	 */
	public universalimageloader.cache.disc.DiskCache getDiskCache() {
		checkConfiguration();
	 ...
	 * You can {@linkplain #init(universalimageloader.core.ImageLoaderConfiguration) init} ImageLoader with new configuration after calling this
	 * method.
	 */
	public void destroy() {
	...
	private static Handler defineHandler(universalimageloader.core.DisplayImageOptions options) {
