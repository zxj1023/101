 ...
 *******************************************************************************/
package universalimageloader.cache.disc.impl.ext;
 ...
 * @since 1.9.2
 */
public class LruDiscCache implements universalimageloader.cache.disc.DiskCache {
	/** {@value */
	...
	protected universalimageloader.cache.disc.impl.ext.DiskLruCache cache;
	...
	private void initCache(File cacheDir, File reserveCacheDir, long cacheMaxSize, int cacheMaxFileCount) {
		try {
			cache = universalimageloader.cache.disc.impl.ext.DiskLruCache.open(cacheDir, 1, 1, cacheMaxSize, cacheMaxFileCount);
		} catch (IOException e) {
			L.e(e);
	...
	public File get(String imageUri) {
		universalimageloader.cache.disc.impl.ext.DiskLruCache.Snapshot snapshot = null;
		try {
	...
	public boolean save(String imageUri, InputStream imageStream, IoUtils.CopyListener listener) throws IOException {
		universalimageloader.cache.disc.impl.ext.DiskLruCache.Editor editor = cache.edit(getKey(imageUri));
		if (editor == null) {
			return false;
		}
