 ...
 *******************************************************************************/
package universalimageloader.utils;
...
public final class MemoryCacheUtils {
	 ...
	 */
	public static String generateKey(String imageUri, universalimageloader.core.assist.ImageSize targetSize) {
	 ...
	 */
	public static List<Bitmap> findCachedBitmapsForImageUri(String imageUri, universalimageloader.cache.memory.MemoryCache memoryCache) {
	 ...
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain ImageLoaderConfiguration configuration}
	 */
	public static List<String> findCacheKeysForImageUri(String imageUri, universalimageloader.cache.memory.MemoryCache memoryCache) {
	 ...
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain ImageLoaderConfiguration configuration}
	 */
	public static void removeFromCache(String imageUri, universalimageloader.cache.memory.MemoryCache memoryCache) {
