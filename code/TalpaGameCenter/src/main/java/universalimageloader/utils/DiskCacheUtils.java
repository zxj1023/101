...
public final class DiskCacheUtils {
	...
	public static File findInCache(String imageUri, universalimageloader.cache.disc.DiskCache diskCache) {
	 ...
	 */
	public static boolean removeFromCache(String imageUri, universalimageloader.cache.disc.DiskCache diskCache) {
		File image = diskCache.get(imageUri);
