...
public final class L {
	...
	/**
	 * Enables/disables detail logging of {@link universalimageloader.core.ImageLoader} work.
	...
	/** Enables/disables logging of {@link universalimageloader.core.ImageLoader} completely (even error logs). */
	...
	private static void log(int priority, Throwable ex, String message, Object... args) {
		...
		Log.println(priority, universalimageloader.core.ImageLoader.TAG, log);
	}
}