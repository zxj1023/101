...
import com.tran.com.android.gc.update.util.Blur;
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
    ...
    public LoadAndDisplayImageTask(ImageLoaderEngine engine, ImageLoadingInfo imageLoadingInfo, Handler handler, Context context, int type) {
        this.engine = engine;
    ...
    public void run() {
        ...
        DisplayBitmapTask displayBitmapTask = new DisplayBitmapTask(bmp, imageLoadingInfo, engine, loadedFrom, bit);
