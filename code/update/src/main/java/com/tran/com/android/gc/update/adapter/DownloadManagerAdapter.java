package com.tran.com.android.gc.update.adapter;
...
import com.tran.com.android.gc.update.util.ProgressBtnUtil;
import com.tran.com.android.gc.update.util.SystemUtils;
import com.tran.com.android.gc.update.widget.ProgressBtn;
import com.tran.com.android.gc.update.widget.stickylistheaders.StickyListHeadersAdapter;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (type) {
            case TYPE_DOWNLOADING:
                ...
                downloadingHolder.download_progress_grey.setProgress(bean.getProgress());
                downloadingHolder.download_progress.setProgress(bean.getProgress());
