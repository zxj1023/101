package com.tran.com.android.gc.update.widget;
...
public class ToCircleView extends View {
	...
	private void init() {
	    ...
	    paint.setColor(getResources().getColor(R.color.progressRoundGreenColor));    //设置画笔颜色  
	    ...
	    endPaint.setColor(getResources().getColor(R.color.progressRoundGreenColor));    //设置画笔颜色  
