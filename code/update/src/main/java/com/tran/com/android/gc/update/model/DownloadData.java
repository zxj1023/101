package com.tran.com.android.gc.update.model;
...
public class DownloadData implements Parcelable {
    ...
    private int forceUpFlag; // 强制升级标识 0 普通升级 1 强制升级
	...
	public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.forceUpFlag);
    }
