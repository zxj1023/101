...
import com.tran.com.android.gc.update.activity.BaseActivity;
...
import com.tran.com.android.gc.update.datauiapi.MarketManager;
import com.tran.com.android.gc.update.datauiapi.bean.appiteminfo;
...
import com.tran.com.android.gc.update.ui.ExpandableTextView;
import com.tran.com.android.gc.update.updateApp;
import com.tran.com.android.gc.update.util.BitmapUtil;
import com.tran.com.android.gc.update.util.CustomAnimCallBack;
import com.tran.com.android.gc.update.util.CustomAnimation;
import com.tran.com.android.gc.update.util.DataFromUtils;
import com.tran.com.android.gc.update.util.Globals;
import com.tran.com.android.gc.update.util.LoadingPageUtil;
import com.tran.com.android.gc.update.util.LoadingPageUtil.OnHideListener;
import com.tran.com.android.gc.update.util.LoadingPageUtil.OnRetryListener;
import com.tran.com.android.gc.update.util.LoadingPageUtil.OnShowListener;
...
public class MarketDetailActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // this.setTheme(style.Theme_Aurora_Dark_Transparent);
    ...
    private void initActionBar() {
        ...
        mActionBar.setTitle(R.string.app_detail_page, Color.BLACK);
    ...
    private void setupAppDetailDisplay(String[] icons) {
        ...
        if ((icons.length == 0) || (!SystemUtils.isLoadingImage(this))) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                lImg.setBackgroundResource(R.drawable.default_icon);
                if (i == 0) {
        ...
        CustomAnimation animation = new CustomAnimation(
                new CustomAnimCallBack() {
                    ...
                    public void callBack(float interpolatedTime,
                        ...
                        {
                            mDownloadBtn.setScaleX(1.0f - 0.478f * interpolatedTime);
                        }
                        else
                        {
                            mDownloadBtn.getBackground().setAlpha(
                                    (int) (255 * (1 - interpolatedTime)));
                            mDownloadBtn.setScaleY(1.0f - 1.8f * (interpolatedTime-0.5f));
                            download_text
                                    .setTextSize(18 * (1 - 0.4f * (interpolatedTime - 0.5f)));
                        }
