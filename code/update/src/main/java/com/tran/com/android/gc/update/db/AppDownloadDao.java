...
public class AppDownloadDao {
    ...
    public void insert(DownloadData data, long createTime, long status,
        ...
        if (db != null) {
            ...
            values.put(AppDownloadHelper.FORCE_UPDATE_FLAG, data.getForceUpFlag());
        ...
        if (db != null) {
            Cursor cursor = db.query(TABLE_NAME,
                    new String[]{AppDownloadHelper.APK_ID,
                            ...
                            AppDownloadHelper.FORCE_UPDATE_FLAG},
                    AppDownloadHelper.APK_ID + "=?",
                    new String[]{appId + ""}, null, null, null);
            if (cursor != null && cursor.moveToFirst()) {
                ...
                downloadData.setForceUpFlag(cursor.getInt(11));
                cursor.close();
                cursor = null;
                return downloadData;
            }
    ...
    public void deleteAll() {
        Log.i("AppDownloadDao", "deleteAll()~~~~~~~~~~~~");
        if (db == null) {
            openDatabase();
        }
        if (db != null) {
