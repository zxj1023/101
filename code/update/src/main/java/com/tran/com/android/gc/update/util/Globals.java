...
public class Globals {
    ...
    //系统编译版本
    public static final String BuildVersion = SystemUtils.getBuildVersion();
	...
	public static final String HTTP_REQUEST_DEFAULT_URL = "http://dev.appmarket.iunios.com/systemappupgradeservice";
//	public static String HTTP_REQUEST_URL = "http://dev.appmarket.iunios.com/systemappupgradeservice";
	...
	public static final String HTTP_SPECIALLIST_METHOD="&action=list";
   ...
   public static final String HTTP_UPGRADEAPP_METHOD="&action=update";
	...
	/*SharedPreferences*/
	public static final String SHARED_WIFI_UPDATE = "wifi.update";
	/*SharedPreferences*/
	public static final String SHARED_APP_UPDATE = "app.update";
	/*SharedPreferences*/
	public static final String SHARED_DATA_UPDATE = "data.update";
	// setting for first login
	public static final String SHARED_FIRST_LOGIN_CONFIG = "user.config";
	public static final String SHARED_FIRST_KEY = "isfirst";
    ...
    //应用列表更新时间
    public static final String SHARED_APP_LIST_UPDATETIME = "app_update_time";
...
/*	public static final String SHARED_WIFI_DISCONNECT_ISEXITS = "wifi_disconnect";
	...
	/*广播*/
	public static final String BROADCAST_ACTION_DOWNLOAD_START = "market.download.start";
	
	public static final String BROADCAST_ACTION_DOWNLOAD = "market.download";
	
	public static final String BROADCAST_ACTION_DOWNLOAD_PAUSE = "market.download.pause";
	
	public static final String BROADCAST_ACTION_INSTALL_WAIT ="market.download.install_wait";
	
	public static final String MARKET_UPDATE_ACTION = "market.action.update";
}
