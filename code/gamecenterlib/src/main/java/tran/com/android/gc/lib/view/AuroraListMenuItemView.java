...
public class AuroraListMenuItemView extends LinearLayout implements AuroraMenuView.ItemView {
	...
	public AuroraListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs);
		mContext = context;
//		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AuroraMenuView,
//				defStyle, 0);

//		mBackground = a.getDrawable(R.styleable.AuroraMenuView_auroraitemBackground);
//		mTextAppearance = a.getResourceId(R.styleable.AuroraMenuView_auroraitemTextAppearance, -1);
//		mPreserveIconSpacing = a.getBoolean(R.styleable.AuroraMenuView_aurorapreserveIconSpacing,
//				false);
