 ...
 * @hide
 */
class AuroraSuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    public AuroraSuggestionsAdapter(Context context, AuroraSearchView searchView,
            SearchableInfo searchable,
            WeakHashMap<String, Drawable.ConstantState> outsideDrawablesCache) {
        super(context,
                R.layout.aurora_search_dropdown_item_icons_2line,
    ...
    private final static class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            mIconRefine = (ImageView) v.findViewById(R.id.aurora_edit_query);
        }
    }
...
//            mContext.getTheme().resolveAttribute(R.attr.textColorSearchUrl, colorValue, true);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            View v = newView(mContext, getCursor(), parent);
            if (v != null) {
