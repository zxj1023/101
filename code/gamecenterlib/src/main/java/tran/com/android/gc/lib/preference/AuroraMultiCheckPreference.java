 ...
 */
public class AuroraMultiCheckPreference extends AuroraDialogPreference {
    ...
    public AuroraMultiCheckPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        // Gionee <zhangxx> <2013-08-14> add for CR00857086 end
            ...
            setEntryValuesCS(a.getTextArray(
                    R.styleable.AuroraListPreference_auroraentryValues));
            a.recycle();
    ...
    public AuroraMultiCheckPreference(Context context) {
        this(context, null);
    }
