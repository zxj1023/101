...
public class AuroraAutoCompleteTextView extends AuroraEditText implements Filter.FilterListener {
    ...
    public AuroraAutoCompleteTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.autoCompleteTextViewStyle);
    }

    public AuroraAutoCompleteTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a =
            context.obtainStyledAttributes(
                attrs, R.styleable.AuroraAutoCompleteTextView, defStyle, 0);

        mThreshold = a.getInt(
                R.styleable.AuroraAutoCompleteTextView_auroracompletionThreshold, 2);

        mPopup.setListSelector(a.getDrawable(R.styleable.AuroraAutoCompleteTextView_auroradropDownSelector));
        mPopup.setVerticalOffset((int)
                a.getDimension(R.styleable.AuroraAutoCompleteTextView_auroradropDownVerticalOffset, 0.0f));
        mPopup.setHorizontalOffset((int)
                a.getDimension(R.styleable.AuroraAutoCompleteTextView_auroradropDownHorizontalOffset, 0.0f));
        
        // Get the anchor's id now, but the view won't be ready, so wait to actually get the
        // view and store it in mDropDownAnchorView lazily in getDropDownAnchorView later.
        // Defaults to NO_ID, in which case the getDropDownAnchorView method will simply return
        // this TextView, as a default anchoring point.
        mDropDownAnchorId = a.getResourceId(R.styleable.AuroraAutoCompleteTextView_auroradropDownAnchor,
                View.NO_ID);
        
        // For dropdown width, the developer can specify a specific width, or MATCH_PARENT
        // (for full screen width) or WRAP_CONTENT (to match the width of the anchored view).
        mPopup.setWidth(a.getLayoutDimension(
                R.styleable.AuroraAutoCompleteTextView_auroradropDownWidth,
                ViewGroup.LayoutParams.WRAP_CONTENT));
        mPopup.setHeight(a.getLayoutDimension(
                R.styleable.AuroraAutoCompleteTextView_auroradropDownHeight,
                ViewGroup.LayoutParams.WRAP_CONTENT));

        mHintResource = a.getResourceId(R.styleable.AuroraAutoCompleteTextView_auroracompletionHintView,
                R.layout.aurora_simple_dropdown_hint);
        
        mPopup.setOnItemClickListener(new DropDownItemClickListener());
        setCompletionHint(a.getText(R.styleable.AuroraAutoCompleteTextView_auroracompletionHint));
        ...
        if (hint != null) {
            if (mHintView == null) {
                final TextView hintView = (TextView) LayoutInflater.from(getContext()).inflate(
                        mHintResource, null).findViewById(R.id.aurora_text1);
     ...
     * @see AuroraAutoCompleteTextView#setOnDismissListener(OnDismissListener)
     */
