...
import tran.com.android.gc.lib.method.AuroraWordIterator;
...
public class AuroraEditText extends EditText{
    ...
    private void init(Context context,AttributeSet attrs,int defStyle){
    	 mContext = context;
         initThemeResource(attrs,defStyle);
    ...
    /**
     * 读取从主题中配置的属性资源，例如文本选择的左右按钮，光标颜色等
     */
    private void initThemeResource(AttributeSet attrs,int defStyle){
    	
    	final Resources.Theme theme = getContext().getTheme();
    	TypedArray a = theme.obtainStyledAttributes(attrs, com.android.internal.R.styleable.TextView, defStyle, 0);
        mHandleLeftRes =   a.getResourceId(com.android.internal.R.styleable.TextView_textSelectHandleLeft, R.drawable.aurora_text_select_handle_left);
        
        mHandleRightRes = a.getResourceId(com.android.internal.R.styleable.TextView_textSelectHandleRight, R.drawable.aurora_text_select_handle_right);
       
        mIsPassword = a.getBoolean(com.android.internal.R.styleable.TextView_password, false);
        a.recycle();
    }
        ...
        if (isMagnifierAndTextSelectionEnabled() && getDefaultEditable()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(mEditorField != null){
                	...
                	AuroraLog.e(TAG,"could not find class or method in class :android.widget.Editor");
				}
                }
...
// Gionee <daizhimin> <2013-08-05> add for CR00845105 begin 
        ...
        public int getExtendedPaddingBottom() {
            return super.getExtendedPaddingBottom() + mContext.getResources().getDimensionPixelOffset(R.dimen.aurora_temp_pading);
        }
/*
        @Override
