...
public interface AuroraMenuPresenter {
	...
	/**
	 * Initialize this presenter for the given context and menu. This method is called by AuroraMenuBuilder when a
	 * presenter is added. See {@link AuroraMenuBuilder#addMenuPresenter(MenuPresenter)}
	 * 
	 * @param context
	...
	/**
	 * Update the menu UI in response to a change. Called by AuroraMenuBuilder during the normal course of
	 * operation.
	 * 
	 * @param cleared
