...
//import tran.com.android.gc.lib.media.VolumeController;
...
// * @hide
// */
//public class AuroraVolumePanel extends Handler implements OnSeekBarChangeListener, View.OnClickListener,
//        VolumeController
//{
...
//    	Log.e("panel", "aurora volume panel");
//
//         Log.e("panel", "onVolumeChanged(streamType: " + ((flags & AudioManager.FLAG_SHOW_UI) != 0));
//        if ((flags & AudioManager.FLAG_SHOW_UI) != 0) {
//        	 Log.e("panel", "onVolumeChanged(streamType: " + streamType + ", flags: " + flags + ")");
//            synchronized (this) {
//            	 Log.e("panel", "onVolumeChanged(streamType 2: " + streamType + ", flags: " + flags + ")");
...
////    	 mDialog.show();
//         Log.e("panel", "mDialog.show()");
//         Log.e("panel", "aurora type:"+streamType+" flags:"+flags);
//
...
//                .setMessage(R.string.safe_media_volume_warning)
//                .setPositiveButton(R.string.aurora_yes,
//                                    new DialogInterface.OnClickListener() {
//                    public void onClick(DialogInterface dialog, int which) {
//                        mAudioService.disableSafeMediaVolume();
//                    }
//                })
//                .setNegativeButton(R.string.aurora_no, null)
...
//	}
//
//	private class AuroraLoadListener implements OnLoadCompleteListener {
