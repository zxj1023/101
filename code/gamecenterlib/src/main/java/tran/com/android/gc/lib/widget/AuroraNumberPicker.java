...
public class AuroraNumberPicker extends LinearLayout {
	...
	private static final String LOG_TAG = "AuroraNumberPicker";
     ...
     * @hide
     */
    public static final AuroraNumberPicker.Formatter TWO_DIGIT_FORMATTER = new AuroraNumberPicker.Formatter() {
    ...
    private int mTextColorTwo;
    private boolean mSetTextColor = false;
    private int mLabelTextYoffset;
    
    private int mTextGapHeight;
    
    private int mLablePaddingRight;
    
    private float mSizeTopAndBottom;
    private float mSizeOther;
    
    private ValueAnimator mSelectedTextAnimator;
    
    private boolean mDrawShader = false;
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(AuroraNumberPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(AuroraNumberPicker view, int scrollState);
    }
     ...
     */
    public AuroraNumberPicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.auroranumberPickerStyle);
    }
     ...
     */
    public AuroraNumberPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        mLablePaddingRight = getResources().getDimensionPixelSize(R.dimen.aurora_number_picker_label_padding_right);
        // process style attributes
        initScrollCache();
        TypedArray attributesArray = context.obtainStyledAttributes(attrs,
                R.styleable.AuroraNumberPicker, defStyle, 0);
        mSolidColor = 0xFFFF0000;//attributesArray.getColor(R.styleable.AuroraNumberPicker_aurorasolidColor, 0);
        mFlingable = true;//attributesArray.getBoolean(R.styleable.NumberPicker_flingable, true);
        mSelectionDivider = attributesArray.getDrawable(R.styleable.AuroraNumberPicker_auroraselectionDivider);
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.AuroraNumberPicker_auroraselectionDividerHeight, defSelectionDividerHeight);
        mMinHeight = attributesArray.getDimensionPixelSize(R.styleable.AuroraNumberPicker_aurorainternalMinHeight,
                SIZE_UNSPECIFIED);
        mMaxHeight = attributesArray.getDimensionPixelSize(R.styleable.AuroraNumberPicker_aurorainternalMaxHeight,
                SIZE_UNSPECIFIED);
        if (mMinHeight != SIZE_UNSPECIFIED && mMaxHeight != SIZE_UNSPECIFIED
                && mMinHeight > mMaxHeight) {
            throw new IllegalArgumentException("minHeight > maxHeight");
        }
        mMinWidth = attributesArray.getDimensionPixelSize(R.styleable.AuroraNumberPicker_aurorainternalMinWidth,
                SIZE_UNSPECIFIED);
        mMaxWidth = attributesArray.getDimensionPixelSize(R.styleable.AuroraNumberPicker_aurorainternalMaxWidth,
                SIZE_UNSPECIFIED);
        ...
        // Gionee zhangxx 2012-11-03 add for CR00724235 begin
        mSelectionSrc = attributesArray.getDrawable(R.styleable.AuroraNumberPicker_auroraselectionSrc);
        int layoutResourceId = attributesArray.getResourceId(R.styleable.AuroraNumberPicker_aurorainternalLayout,
                R.layout.aurora_number_picker);
        // Gionee zhangxx 2012-11-03 add for CR00724235 end
        ...
        mOtherTextSize = DensityUtil.dip2px(getContext(), 17);
        mSelectedTextSize = DensityUtil.dip2px(getContext(), 25);
        mLabelTextSize = DensityUtil.dip2px(getContext(), 10);
        
        mLabelTextYoffset = DensityUtil.dip2px(getContext(), 2);
        
        mTextGapHeight = DensityUtil.dip2px(getContext(), 13);
        mSizeOther = mOtherTextSize;
        // Gionee zhangxx 2012-11-03 add for CR00724235 end
        setPadding(0, 0, 0, 0);
...
//                mInputText.clearFocus();
                if (v.getId() == R.id.aurora_increment) {
...
//                mInputText.clearFocus();
        ...
        // increment button
        mIncrementButton = (ImageButton) findViewById(R.id.aurora_increment);
        mIncrementButton.setOnClickListener(onClickListener);
        mIncrementButton.setOnLongClickListener(onLongClickListener);

        // decrement button
        mDecrementButton = (ImageButton) findViewById(R.id.aurora_decrement);
        mDecrementButton.setOnClickListener(onClickListener);
        mDecrementButton.setOnLongClickListener(onLongClickListener);

        // input text
        mInputText = (EditText) findViewById(R.id.aurora_numberpicker_input);
...
//        mInputText.setImeOptions(EditorInfo.IME_ACTION_DONE);
        ...
        mSelectedTextColor = getResources().getColor(R.color.aurora_numberpicker_select_text_color);
        mTextColorOne = getResources().getColor(R.color.aurora_numberpicker_bottom_color);
        mTextColorTwo = getResources().getColor(R.color.aurora_numberpicker_mid_color);
        setFadingEdgeLength(100);
//        setFadeColor(0xFFFF0000);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                Log.e("poss", "mLastMotionEventY:"+mLastMotionEventY);
                removeAllCallbacks();
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                AuroraLog.e(LOG_TAG, "deltaMoveY Y:"+deltaMoveY);
                mDeltaY = currentMoveY - mTouchDownY;
...
//                }
    ...
    public void scrollBy(int x, int y) {
        ...
        while (mCurrentScrollOffset - mInitialScrollOffset > mSelectorTextGapHeight) {
            Log.e("poss", "mCurrentScrollOffset:"+(mCurrentScrollOffset - mInitialScrollOffset));
            Log.e("poss", "mSelectorTextGapHeight:"+mSelectorTextGapHeight);
        ...
        while (mCurrentScrollOffset - mInitialScrollOffset < -mSelectorTextGapHeight) {
            mCurrentScrollOffset += mSelectorElementHeight;
            Log.e("poss", "mCurrentScrollOffset 2:"+(mCurrentScrollOffset - mInitialScrollOffset));
            Log.e("poss", "mSelectorTextGapHeight 2:"+mSelectorTextGapHeight);
...
//        mSelectedTextAnimator = ValueAnimator.ofInt(0,20);
//        mSelectedTextAnimator.setDuration(50);
//        mSelectedTextAnimator.addUpdateListener(new AnimatorUpdateListener() {
//            
//            @Override
//            public void onAnimationUpdate(ValueAnimator animation) {
//                // TODO Auto-generated method stub
//                mMiddleY = (Integer) animation.getAnimatedValue();
//            }
//        });
//        mSelectedTextAnimator.start();
    }
     ...
     * <p>
     * If the argument is less than the {@link AuroraNumberPicker#getMinValue()} and
     * {@link AuroraNumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link AuroraNumberPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link AuroraNumberPicker#getMinValue()} and
     * {@link AuroraNumberPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link AuroraNumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link AuroraNumberPicker#getMaxValue()} and
     * {@link AuroraNumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link AuroraNumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link AuroraNumberPicker#getMinValue()} and
     * {@link AuroraNumberPicker#getMaxValue()} values.
     * <p>
    ...
    protected void onDraw(Canvas canvas) {
    	AuroraLog.e(LOG_TAG, "height:"+(mDeltaY/mTotalHeight));
    	
        if (mSelectorWheelState == SELECTOR_WHEEL_STATE_NONE) {
            return;
        }
        float deltaOffset = Math.abs((mDeltaY/mTotalHeight/2)*100);
        
        float x = (/*mRight - mLeft*/getRight() - getLeft()) / 2;
        float y = mCurrentScrollOffset;
//        float y = mOtherTextSize;
        ...
        int[] selectorIndices = mSelectorIndices;
        Shader shader =null;// new LinearGradient(0, mTotalHeight/2+mTotalHeight/4, 0,mTotalHeight , Color.RED/*mTextColorOne|0xFF000000*/, 0, Shader.TileMode.CLAMP);
        Shader shader2 = null;//new LinearGradient(0,mTotalHeight/2 , 0,0 , Color.GREEN/*mTextColorOne|0xFF000000*/, 0, Shader.TileMode.CLAMP);
        Paint paint2 = new Paint();
        paint2.set(mSelectorWheelPaint);
...
//            	if(selectorIndex)
            ...
            float textSize = mSizeOther;//DensityUtil.dip2px(getContext(), 17);
			if (i == SELECTOR_MIDDLE_ITEM_INDEX) {
				textColor = mSelectedTextColor;
				y += DensityUtil.dip2px(getContext(), 18);
				textSize = mSelectedTextSize;
//				mSelectorWheelPaint.setShader(null);
				mSelectorWheelPaint.setShader(null);
				mSelectorWheelPaint.setColor(textColor);
				mSelectorWheelPaint.setTextSize(textSize);
				canvas.drawText(scrollSelectorValue, x, y, mSelectorWheelPaint);

			} else if (i == SELECTOR_MIDDLE_ITEM_INDEX - 1) {
				textColor = mTextColorTwo;
				textSize = mSizeOther;
				// shader = new LinearGradient(0, y, 0,mTotalHeight ,
				// Color.GREEN/*mTextColorOne|0xFF000000*/, 0,
				// Shader.TileMode.CLAMP);
				paint2.setShader(null);
				paint2.setColor(textColor);
				paint2.setTextSize(textSize);
				canvas.drawText(scrollSelectorValue, x, y, paint2);
			} else if (i == SELECTOR_MIDDLE_ITEM_INDEX - 2) {
				textColor = mTextColorOne;
				// shader = new LinearGradient(0, mTotalHeight/5, 0,0,
				// Color.RED/*mTextColorOne|0xFF000000*/, 0,
				// Shader.TileMode.CLAMP);
				shader = new  LinearGradient(0,mTotalHeight/4 , 0,0 , mTextColorTwo, 0, Shader.TileMode.CLAMP);
				paint2.setShader(shader);
				paint2.setColor(textColor);
				paint2.setTextSize(textSize);
				canvas.drawText(scrollSelectorValue, x, y, paint2);
			} else if (i == SELECTOR_MIDDLE_ITEM_INDEX + 2) {
				AuroraLog.e(LOG_TAG, "YYY:" + mTotalHeight);
				textColor = mTextColorOne;
				shader2 = new  LinearGradient(0, mTotalHeight-mTotalHeight/4, 0,mTotalHeight , mTextColorTwo, 0, Shader.TileMode.CLAMP);
				mSelectorWheelPaint.setShader(shader2);
				mSelectorWheelPaint.setColor(textColor);
				mSelectorWheelPaint.setTextSize(textSize);
				canvas.drawText(scrollSelectorValue, x, y, mSelectorWheelPaint);
			} else if (i == SELECTOR_MIDDLE_ITEM_INDEX + 1) {
				...
				textSize = mSizeOther;
				paint2.setShader(null);
				y += DensityUtil.dip2px(getContext(), 17);
				paint2.setColor(textColor);
				paint2.setTextSize(textSize);
				canvas.drawText(scrollSelectorValue, x, y, paint2);
			}
...
//            y += mOtherTextSize+mSelectorTextGapHeight;
        ...
        if (mSelectionDivider != null) {
            ...
            mSelectionDivider.setBounds(0, topOfTopDivider, /*mRight*/getRight(), bottomOfTopDivider);
            ...
            mSelectionDivider.setBounds(0, topOfBottomDivider, /*mRight*/getRight(), bottomOfBottomDivider);
            mSelectionDivider.draw(canvas);
        }
        // Gionee zhangxx 2012-11-03 add for CR00724235 begin
            ...
            int topOfTopDivider =
                (getHeight() - mSelectorElementHeight - mSelectionDividerHeight) / 2;
            int bottomOfBottomDivider = topOfTopDivider + mSelectorElementHeight+DensityUtil.dip2px(getContext(), 10);
            mSelectionSrc.setBounds(0, topOfTopDivider-mLabelTextSize, getWidth(), bottomOfBottomDivider);
        ...
        if(mLable != null){
        	...
        	int topOfTopDivider =
                    (getHeight() - mSelectorElementHeight - mSelectionDividerHeight) / 2;
        	int bottomOfBottomDivider = topOfTopDivider + mSelectorElementHeight+DensityUtil.dip2px(getContext(), 10);
        	if(mSelectionSrc == null){
        	    mSelectionSrc = new ColorDrawable(0x00000000);
        	    mSelectionSrc.setBounds(0, topOfTopDivider-mLabelTextSize, getWidth(), bottomOfBottomDivider);
        	}
        	if(mSetTextColor){
        	    mSelectorWheelPaint.setColor(mSelectedTextColor);
            }else{
                mSelectorWheelPaint.setColor(getContext().getResources().getColor(R.color.aurora_numberpicker_select_text_color));
            }
        	
        	mSelectorWheelPaint.setTextSize(mLabelTextSize);
        	canvas.drawText(mLable.toString(), mSelectionSrc.getBounds().right-mLablePaddingRight, topOfTopDivider+mLabelTextYoffset, mSelectorWheelPaint);
        }
        // Gionee zhangxx 2012-11-03 add for CR00724235 end
    ...
    public void setSelectedTextSize(float size){
        mSelectedTextSize = DensityUtil.dip2px(getContext(), size);
    }
    
    public void setOtherItemTextSize(float sizeTopAndBottom,float other){
        
        mSizeTopAndBottom = DensityUtil.dip2px(getContext(), sizeTopAndBottom);
        mSizeOther = DensityUtil.dip2px(getContext(), other);
        mTextGapHeight = mTextGapHeight + DensityUtil.dip2px(getContext(), 3);
    }
    ...
    public void setTextColor(int colorOne,int colorSelected,int colorTwo){
        mSetTextColor = true;
        mSelectedTextColor = colorSelected;
        mTextColorOne = colorOne;
        mTextColorTwo = colorTwo;
    ...
    private void initializeSelectorWheel() {
        initializeSelectorWheelIndices();
        int[] selectorIndices = mSelectorIndices;
        int totalTextHeight = (int)((selectorIndices.length ) * mOtherTextSize + mSelectedTextSize+30);
        float totalTextGapHeight = (/*mBottom - mTop*/getBottom()-getTop()) - totalTextHeight;
        float textGapCount = selectorIndices.length;// - 1;
        mSelectorTextGapHeight = (int) (totalTextGapHeight / textGapCount );
        mSelectorElementHeight = mOtherTextSize + mSelectorTextGapHeight;
        // Ensure that the middle item is positioned the same as the text in mInputText
        int editTextTextPosition = mInputText.getBaseline() + mInputText.getTop();
        mInitialScrollOffset = editTextTextPosition -
                (mSelectorElementHeight * SELECTOR_MIDDLE_ITEM_INDEX)-mOtherTextSize;
        mCurrentScrollOffset = mInitialScrollOffset;
        updateInputTextView();
    }
...
//            mDecrementButton.setVisibility(INVISIBLE);
//        }
        mIncrementButton.setVisibility(GONE);
        mDecrementButton.setVisibility(GONE);
    }
...
//        mInputText.clearFocus();
    ...
    private void initScrollCache() {
        if (mScrollCache == null) {
            mScrollCache = new ScrollabilityCache(ViewConfiguration.get(getContext()), this);
            mScrollCache.setFadeColor(0xFFFF0000);
        }
    }
...
//    	mHandler.removeCallbacks(mScrollCache);
//    	mHandler.post(mScrollCache);
    }
