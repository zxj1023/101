 ...
 */
public abstract class AuroraAbsSpinner extends AuroraAdapterView {
    ...
    public AuroraAbsSpinner(Context context) {
        super(context);
        initAbsSpinner();
    }

    public AuroraAbsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AuroraAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (entries != null) {
            ArrayAdapter<CharSequence> adapter =
                    new ArrayAdapter<CharSequence>(context,
                            R.layout.aurora_simple_spinner_item, entries);
            adapter.setDropDownViewResource(R.layout.aurora_spinner_list_item);
            setAdapter(adapter);
        }
...
//                : mSelectionRightPadding;
    ...
    void recycleAllViews() {
        ...
        final AuroraAbsSpinner.RecycleBin recycleBin = mRecycler;
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link AuroraAbsSpinner#onSaveInstanceState()}
         */
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(AuroraAbsSpinner.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(AuroraAbsSpinner.class.getName());
    }
}
