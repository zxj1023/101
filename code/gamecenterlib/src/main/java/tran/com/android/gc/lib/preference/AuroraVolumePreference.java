 ...
 * @hide
 */
public class AuroraVolumePreference extends AuroraSeekBarDialogPreference implements
AuroraPreferenceManager.OnActivityStopListener, View.OnKeyListener {
    ...
    public AuroraVolumePreference(Context context, AttributeSet attrs) {
        ...
        if (NativePreferenceManager.getAnalyzeNativePreferenceXml() && attrs != null) {
            ...
            for (i=0; i<attrs.getAttributeCount(); i++) {
                ...
                switch (id) {
                    case android.R.attr.streamType:
                        mStreamType = attrs.getAttributeIntValue(i, 0);
                        break;
                }
            }
        } else {
        // Gionee <zhangxx> <2013-08-14> modify for CR00857086 end
            TypedArray a = context.obtainStyledAttributes(attrs,
                    R.styleable.AuroraVolumePreference, 0, 0);
            mStreamType = a.getInt(R.styleable.AuroraVolumePreference_aurorastreamType, 0);
            a.recycle();
        // Gionee <zhangxx> <2013-08-14> modify for CR00857086 begin
        }
        // Gionee <zhangxx> <2013-08-14> modify for CR00857086 end
    ...
    protected void onBindDialogView(View view) {
        ...
        final SeekBar seekBar = (SeekBar) view.findViewById(R.id.aurora_seekbar);
       ...
       if (mSeekBarVolumizer != null) {
           ...
           if (dialog != null && dialog.isShowing()) {
               View view = dialog.getWindow().getDecorView()
                       .findViewById(R.id.aurora_seekbar);
