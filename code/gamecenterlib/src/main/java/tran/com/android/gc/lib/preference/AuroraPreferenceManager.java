 ...
 */
public class AuroraPreferenceManager {
     ...
     */
    public static final String METADATA_KEY_PREFERENCES = "tran.com.android.gc.lib.preference";
     ...
     */
    private AuroraPreferenceFragment mFragment;
    ...
    AuroraPreferenceManager(Activity activity, int firstRequestCode) {
        mActivity = activity;
     ...
     */
    private AuroraPreferenceManager(Context context) {
        init(context);
    }
     ...
     */
    void setFragment(AuroraPreferenceFragment fragment) {
        mFragment = fragment;
    }
     ...
     */
    AuroraPreferenceFragment getFragment() {
        return mFragment;
    }
     ...
     *         root).
     */
    AuroraPreferenceScreen inflateFromIntent(Intent queryIntent, AuroraPreferenceScreen rootPreferences) {
        ...
        for (int i = activities.size() - 1; i >= 0; i--) {
            ...
            if (!inflatedRes.contains(uniqueResId)) {
                ...
                final AuroraPreferenceInflater inflater = new AuroraPreferenceInflater(context, this);
                final XmlResourceParser parser = activityInfo.loadXmlMetaData(context
                        .getPackageManager(), METADATA_KEY_PREFERENCES);
                rootPreferences = (AuroraPreferenceScreen) inflater
     ...
     * @hide
     */
    public AuroraPreferenceScreen inflateFromResource(Context context, int resId,
            AuroraPreferenceScreen rootPreferences) {
        // Block commits
        setNoCommit(true);

        final AuroraPreferenceInflater inflater = new AuroraPreferenceInflater(context, this);
        rootPreferences = (AuroraPreferenceScreen) inflater.inflate(resId, rootPreferences, true);
        rootPreferences.onAttachedToHierarchy(this);
    ...
    public AuroraPreferenceScreen createPreferenceScreen(Context context) {
        final AuroraPreferenceScreen preferenceScreen = new AuroraPreferenceScreen(context, null);
     ...
     */
    AuroraPreferenceScreen getPreferenceScreen() {
     ...
     */
    boolean setPreferences(AuroraPreferenceScreen preferenceScreen) {
    ...
    public static void setDefaultValues(Context context, String sharedPreferencesName,
        ...
        if (readAgain || !defaultValueSp.getBoolean(KEY_HAS_SET_DEFAULT_VALUES, false)) {
            final AuroraPreferenceManager pm = new AuroraPreferenceManager(context);
