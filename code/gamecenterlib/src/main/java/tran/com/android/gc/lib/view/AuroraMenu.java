...
public interface AuroraMenu {
	 ...
	 */
	public AuroraMenuItem add(CharSequence title);
	 ...
	 * @return The newly added menu item.
	 */
	public AuroraMenuItem add(int titleRes);
	 ...
	 *            {@link AuroraMenuItem#getOrder()}.
	 * @param title
	 *            The text to display for the item.
	 * @return The newly added menu item.
	 */
	public AuroraMenuItem add(int groupId, int itemId, int order, CharSequence title);
	 ...
	 * @return The newly added menu item.
	 */
	public AuroraMenuItem add(int groupId, int itemId, int order, int titleRes);

	/**
	 * Add a new sub-menu to the menu. This item displays the given title for its label. To modify other
	 * attributes on the AuroraSubMenu's menu item, use {@link AuroraSubMenu#getItem()}.
	 * 
	 * @param title
	 *            The text to display for the item.
	 * @return The newly added sub-menu
	 */
	AuroraSubMenu addSubMenu(final CharSequence title);
	 ...
	 * @return The newly added sub-menu
	 */
	AuroraSubMenu addSubMenu(final int titleRes);

	/**
	 * Add a new sub-menu to the menu. This item displays the given <var>title</var> for its label. To modify
	 * other attributes on the AuroraSubMenu's menu item, use {@link AuroraSubMenu#getItem()}.
	 * <p>
	 * Note that you can only have one level of sub-menus, i.e. you cannnot add a AuroraSubMenu to a AuroraSubMenu: An
	 ...
	 * @return The newly added sub-menu
	 */
	AuroraSubMenu addSubMenu(final int groupId, final int itemId, int order, final CharSequence title);
	 ...
	 * @return The newly added sub-menu
	 */
	AuroraSubMenu addSubMenu(int groupId, int itemId, int order, int titleRes);
	 ...
	 * parameter. For each of the generated items {@link AuroraMenuItem#setIntent} is called to associate the
	...
	public int addIntentOptions(int groupId, int itemId, int order, ComponentName caller, Intent[] specifics,
			Intent intent, int flags, AuroraMenuItem[] outSpecificItems);
	 ...
	 * {@link AuroraMenuItem#setCheckable} on all of the menu items with the given group identifier, but in
	 ...
	 * 
	 * @see AuroraMenuItem#setCheckable
	 * @see AuroraMenuItem#setChecked
	 */
	 ...
	 */
	public AuroraMenuItem findItem(int id);
	 ...
	 */
	public AuroraMenuItem getItem(int index);
