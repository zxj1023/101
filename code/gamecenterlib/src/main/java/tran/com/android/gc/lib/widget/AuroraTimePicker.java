...
public class AuroraTimePicker extends FrameLayout {
    ...
    public AuroraTimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(
                attrs, R.styleable.AuroraTimePicker, defStyle, 0);
        int layoutResourceId = attributesArray.getResourceId(
                R.styleable.AuroraTimePicker_aurorainternalLayout,
                R.layout.aurora_time_picker);
        mHideApPm = attributesArray.getBoolean(
                R.styleable.AuroraTimePicker_hideAmPm, false);
        mIs24HourView = attributesArray.getBoolean(
                R.styleable.AuroraTimePicker_is24Hour, true);
        ...
        // hour
        mHourSpinner = (AuroraNumberPicker) findViewById(R.id.aurora_hour);
        mHourSpinner.setLabel(getResources().getString(
                R.string.aurora_time_picker_hour_lebel));
        ...
        mHourSpinnerInput = (EditText) mHourSpinner
                .findViewById(R.id.aurora_numberpicker_input);
        mHourSpinnerInput.setImeOptions(EditorInfo.IME_ACTION_NEXT);

        // divider (only for the new widget style)
        /*
         * mDivider = (TextView)
         * findViewById(R.id.aurora_divider); if (mDivider
         * != null) { mDivider.setText(R.string.time_picker_separator); }
         */

        // minute
        mMinuteSpinner = (AuroraNumberPicker) findViewById(R.id.aurora_minute);
        mMinuteSpinner.setMinValue(0);
        mMinuteSpinner.setMaxValue(59);
        mMinuteSpinner.setLabel(getResources().getString(
                R.string.aurora_time_picker_m_label));
        ...
        // am/pm
        View amPmView = findViewById(R.id.aurora_amPm);
    ...
    private void setContentDescriptions() {
         ...
         * R.id.aurora_increment,
         * R.string.time_picker_increment_minute_button);
         * trySetContentDescription(mMinuteSpinner,
         * R.id.aurora_decrement,
