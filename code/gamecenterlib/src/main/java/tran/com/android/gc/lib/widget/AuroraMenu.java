...
public class AuroraMenu extends AuroraMenuBase {
	...
	private View.OnClickListener onlClickListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			position = 0;
			int i = v.getId();
			if (i == R.id.aurora_action_bottom_bar_menu_item_layout1 || i == R.id.aurora_action_bottom_bar_menu_item_text1 || i == R.id.aurora_action_bottom_bar_menu_item_image1) {
				position = 0;

			} else if (i == R.id.aurora_action_bottom_bar_menu_item_layout2 || i == R.id.aurora_action_bottom_bar_menu_item_text2 || i == R.id.aurora_action_bottom_bar_menu_item_image2) {
				position = 1;

			} else if (i == R.id.aurora_action_bottom_bar_menu_item_layout3 || i == R.id.aurora_action_bottom_bar_menu_item_text3 || i == R.id.aurora_action_bottom_bar_menu_item_image3) {
				position = 2;

			} else if (i == R.id.aurora_action_bottom_bar_menu_item_image4) {
				position = 3;

			} else if (i == R.id.aurora_action_bottom_bar_menu_item_image5) {
				position = 4;
