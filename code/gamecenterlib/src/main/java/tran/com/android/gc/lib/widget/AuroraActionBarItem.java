...
public abstract class AuroraActionBarItem {
	...
	public static AuroraActionBarItem createWithType(AuroraActionBar actionBar,
		...
		switch (type) {
		case GoHome:
			drawableId = R.drawable.aurora_action_bar_home;
			descriptionId = R.string.aurora_go_home;
			break;

		case Info:
			drawableId = R.drawable.aurora_action_bar_info;
			descriptionId = R.string.aurora_info;
			break;

		case Back:
			drawableId = R.drawable.aurora_action_bar_back;
			descriptionId = R.string.aurora_back;
			break;

		case More:
			drawableId = R.drawable.aurora_action_bar_more;
			descriptionId = R.string.aurora_more;
			break;
			
		case Add:
			drawableId = R.drawable.aurora_action_bar_add;
			descriptionId = R.string.aurora_add;
			break;
			
		case Edit:
			drawableId = R.drawable.aurora_action_bar_edit;
			descriptionId =R.string.aurora_edit;
			break;
