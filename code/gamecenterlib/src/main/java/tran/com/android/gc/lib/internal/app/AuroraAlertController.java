...
package tran.com.android.gc.lib.internal.app;
...
import tran.com.android.gc.lib.view.AuroraDialogTitle;
import tran.com.android.gc.lib.utils.AuroraLog;
import tran.com.android.gc.lib.utils.DensityUtil;

import tran.com.android.gc.lib.app.AuroraMultipleChoiceListener;
import tran.com.android.gc.lib.widget.AuroraCheckBox;
import tran.com.android.gc.lib.widget.AuroraCheckedTextView;
...
//            }
        ...
        if (hasTitle) {
            ...
            if (divider != null) {
                Log.e("luofu", "dialog title divider");
...
//        }
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel,
        ...
        int fullDark =a.getResourceId(
                R.styleable.AuroraAlertDialog_aurorafullDark,
                R.drawable.aurora_popup_full_dark);
        int topDark = a.getResourceId(
                R.styleable.AuroraAlertDialog_auroratopDark,
                R.drawable.aurora_popup_top_dark);
        int centerDark = a.getResourceId(
                R.styleable.AuroraAlertDialog_auroracenterDark,
                R.drawable.aurora_popup_center_dark);
        int bottomDark = a.getResourceId(
                R.styleable.AuroraAlertDialog_aurorabottomDark,
                R.drawable.aurora_popup_bottom_dark);
        int fullBright = a.getResourceId(
                R.styleable.AuroraAlertDialog_aurorafullBright,
                R.drawable.aurora_popup_full_bright);
        int topBright = a.getResourceId(
                R.styleable.AuroraAlertDialog_auroratopBright,
                R.drawable.aurora_popup_top_bright);
        int centerBright = a.getResourceId(
                R.styleable.AuroraAlertDialog_auroracenterBright,
                R.drawable.aurora_popup_center_bright);
        int bottomBright = a.getResourceId(
                R.styleable.AuroraAlertDialog_aurorabottomBright,
                R.drawable.aurora_popup_bottom_bright);
        int bottomMedium = a.getResourceId(
                R.styleable.AuroraAlertDialog_aurorabottomMedium,
                R.drawable.aurora_popup_bottom_medium);
        if(hasButtons){
            if(contentPanel != null){
                contentPanel.setBackgroundColor(Color.WHITE);
            }
            if(customPanel != null){
                customPanel.setBackgroundColor(Color.WHITE);
            }
            ...
            if(customPanel != null){
                customPanel.setBackgroundResource(bottomBright);
            }
        }
        ...
        private ListAdapter getMultipleChoiceCursorAdapter(final ListView listView,final AuroraAlertController dialog){
        	ListAdapter adapter = new CursorAdapter(mContext, mCursor, false) {
                ...
                public void bindView(View view, Context context, Cursor cursor) {
                        AuroraCheckedTextView text = (AuroraCheckedTextView) view.findViewById(android.R.id.text1);
