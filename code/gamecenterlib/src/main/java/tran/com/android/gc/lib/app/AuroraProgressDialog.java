...
//                        String tmp = String.valueOf(percent);
            ...
            View view = inflater.inflate(a.getResourceId(
            		R.styleable.AuroraAlertDialog_aurorahorizontalProgressLayout,
                    R.layout.aurora_alert_dialog_progress), null);
            mProgress = (ProgressBar) view.findViewById(R.id.aurora_progress);
            mProgressNumber = (TextView) view.findViewById(R.id.aurora_progress_number);
            mProgressPercent = (TextView) view.findViewById(R.id.aurora_progress_percent);
            setView(view);
        } else {
            mIsSpinnerProgress = true;
            View view = inflater.inflate(a.getResourceId(
            		R.styleable.AuroraAlertDialog_auroraprogressLayout,
            		R.layout.aurora_progress_dialog), null);
            mSpinnerBody = (LinearLayout)view.findViewById(R.id.aurora_body);
            mProgress = (ProgressBar) view.findViewById(R.id.aurora_progress);
            mMessageView = (TextView) view.findViewById(R.id.aurora_message);
            setView(view);
        }
        a.recycle();
        if (mMax > 0) {
