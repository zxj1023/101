...
import tran.com.android.gc.lib.app.AuroraListActivity;
 ...
 * href="{@docRoot}, read the <a href="{@docRoot}
 * , read the <a href="{@docRoot}, read the <a href="{@docRoot}, read the <a
 * href="{@docRoot}, read the <a href="{@docRoot} , read the <a href="{@docRoot}
 * , read the <a href="{@docRoot}, read the <a href="{@docRoot}, read the <a
 ...
 * themselves.
 */
public abstract class AuroraPreferenceActivity extends AuroraListActivity implements
        AuroraPreferenceManager.OnPreferenceTreeClickListener,
        AuroraPreferenceFragment.OnPreferenceStartFragmentCallback {
    ...
    interface OnFragmentCreatedListener {
        ...
        boolean fragmentCreated(boolean created);
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        Header listHeader = new Header();
        Header listFooter = new Header();
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                view = mInflater.inflate(R.layout.aurora_preference_header_item,
                        parent, false);
            ...
            if (!TextUtils.isEmpty(summary)) {
                ...
                auroraSetPreferenceItemHeight(view, 71);
            } else {
                holder.summary.setVisibility(View.GONE);
                auroraSetPreferenceItemHeight(view, 47);
            }
        ...
        /*
         * adap preference item height params: v: which preference element
         * height : set to this height minHeight : true means most min height
         * ,otherwise the height forever
         */
        private void auroraSetPreferenceItemHeight(View v, int height)
        {
            ...
            // if(minHeight)
            v.setMinimumHeight(params.height);
            // else
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setContentView(R.layout.aurora_preference_list_content);
        setAuroraContentView(R.layout.aurora_preference_list_content);
        mListFooter = (FrameLayout) findViewById(R.id.aurora_list_footer);
        mContainerlayout = (LinearLayout) findViewById(R.id.aurora_preference_list_layout);
        mPrefsContainer = (ViewGroup) findViewById(R.id.aurora_prefs_frame);
        ...
        mPreferenceManager = new AuroraPreferenceManager(this, FIRST_REQUEST_CODE);
        ...
        if (initialFragment != null && mSinglePane) {
            ...
            findViewById(R.id.aurora_headers).setVisibility(View.GONE);
            ...
            // of preferences" mode.
            // setContentView(R.layout.aurora_preference_list_content_single);
            setAuroraContentView(R.layout.aurora_preference_list_content_single);
            addHeaderAndFooterViewToList();
            mListFooter = (FrameLayout) findViewById(R.id.aurora_list_footer);
            mPrefsContainer = (ViewGroup) findViewById(R.id.aurora_prefs);
            // mPreferenceManager = new AuroraPreferenceManager(this,
            // FIRST_REQUEST_CODE);
            mContainerlayout = (LinearLayout) findViewById(R.id.aurora_preference_list_layout);
        ...
        if (intent.getBooleanExtra(EXTRA_PREFS_SHOW_BUTTON_BAR, false)) {
            ...
            findViewById(R.id.aurora_button_bar).setVisibility(View.VISIBLE);

            Button backButton = (Button) findViewById(R.id.aurora_back_button);
            ...
            Button skipButton = (Button) findViewById(R.id.aurora_skip_button);
            ...
            mNextButton = (Button) findViewById(R.id.aurora_next_button);
        ...
        // resetLayoutPadding();
       mParent = findViewById(R.id.aurora_preference_list_layout);
    ...
    public void setParentLayoutBackgroundResource(int resId){
        if(mParent != null){
            mParent.setBackgroundResource(resId);
        }
    }
    public void setParentLayoutBackgroundDrawable(Drawable drawable){
        if(mParent != null){
    ...
    private void addHeaderAndFooterViewToList() {
        ...
        headerView = inflater.inflate(R.layout.aurora_preference_list_padding_top, null);
        footerView = inflater.inflate(R.layout.aurora_preference_list_padding_bottom,
                null);
...
//                CharSequence title = ((AuroraPreferenceCategory) mFirstPreference).getTitle();
...
//                }
    ...
    private void refreshPaddintTop() {
        if (mList == null) {
            return;
        }
        ...
        RefreshPaddingListener listener = new RefreshPaddingListener();
        // listener.setCallback(new Callback() {
        //
        // @Override
        // public void execute(int padding) {
        // // TODO Auto-generated method stub
        // resetLayoutPadding(padding);
        // }
        // });

        // mList.setOnScrollListener(new RefreshPaddingListener());
        mList.setOnScrollListener(new OnScrollListener() {
            private int getLastVisiblePosition = 0, lastVisiblePositionY = 0;
            private int getFirstVisiblePosition = -1, firstVisiblePositionY = -1;
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
                    ...
                    if (view.getLastVisiblePosition() == (view.getCount() - 1)) {
                        ...
                        {
                            Toast.makeText(view.getContext(), "bottom", 500).show();
                            getLastVisiblePosition = view.getLastVisiblePosition();
                            lastVisiblePositionY = y;
                            resetLayoutPadding(0, 64);
                            return;
                        }
                    ...
                    if (view.getFirstVisiblePosition() == 0) {
                        ...
                        Log.e("x" + location[0], "y" + location[1]);
                        if (view.getFirstVisiblePosition() != getFirstVisiblePosition
                                && firstVisiblePositionY != y)// 第一次拖至底部
                        {
                            Toast.makeText(view.getContext(), "top", 500).show();
                            getFirstVisiblePosition = view.getFirstVisiblePosition();
                            firstVisiblePositionY = y;
                            resetLayoutPadding(20, 0);
                            return;
                        }

                    }
                    getFirstVisiblePosition = -1;
                    firstVisiblePositionY = -1;
                    // 未滚动到底部，第二次拖至底部都初始化
    ...
    private void resetLayoutPadding(int paddingTop, int paddingBottom) {
        mPreferenceScreen = mPreferenceManager.getPreferenceScreen();
        if (mPreferenceScreen == null) {
            Log.e("luofu", "mPreferenceScreen null");
            return;
        }
        if (mPreferenceScreen.getPreferenceCount() <= 0) {
            Log.e("luofu", "count null");
            return;
        }
        mFirstPreference = mPreferenceScreen.getPreference(0);

        if (mFirstPreference == null) {
            Log.e("luofu", "mFirstPreference null");
            return;
        }

        if (mFirstPreference instanceof AuroraPreferenceCategory) {
            if (mContainerlayout != null) {
                Log.e("luofu", "refresh layout padding");
                mContainerlayout.setPadding(mContainerlayout.getPaddingLeft(), paddingTop,
                        mContainerlayout.getPaddingRight(), paddingBottom);
    ...
    public boolean onIsMultiPane() {
        boolean preferMultiPane = getResources().getBoolean(
                R.bool.aurora_preferences_prefer_dual_pane);
            ...
            while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
                ...
                if ("header".equals(nodeName)) {
                    ...
                    TypedArray sa = getResources().obtainAttributes(attrs,
                            R.styleable.AuroraPreferenceHeader);
                    header.id = sa.getResourceId(
                            R.styleable.AuroraPreferenceHeader_auroraid,
                            (int) HEADER_ID_UNDEFINED);
                    TypedValue tv = sa.peekValue(
                            R.styleable.AuroraPreferenceHeader_auroratitle);
                    ...
                    tv = sa.peekValue(
                            R.styleable.AuroraPreferenceHeader_aurorasummary);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    tv = sa.peekValue(
                            R.styleable.AuroraPreferenceHeader_aurorabreadCrumbTitle);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    tv = sa.peekValue(
                            R.styleable.AuroraPreferenceHeader_aurorabreadCrumbShortTitle);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    header.iconRes = sa.getResourceId(
                            R.styleable.AuroraPreferenceHeader_auroraicon, 0);
                    header.fragment = sa.getString(
                            R.styleable.AuroraPreferenceHeader_aurorafragment);
                    sa.recycle();
    ...
    protected void onListItemClick(AuroraListView l, View v, int position, long id) {
        ...
        // Aurora <Luofu> <2013-11-18> modify for Preference padding top and
        // padding bottom begin
        Object item;
        int listHeaderCount = mList.getHeaderViewsCount();
        if (getListAdapter() != null) {
            if (listHeaderCount > 0) {
                item = getListAdapter().getItem(position - listHeaderCount);
            } else {
    ...
    public void showBreadCrumbs(CharSequence title, CharSequence shortTitle) {
        if (mFragmentBreadCrumbs == null) {
            ...
            if (mFragmentBreadCrumbs == null) {
                if (title != null) {
                    // setTitle(title);
                    // AURORA-START::add for ActionBar
                    // Title::waynelin::2013-9-17
                    getAuroraActionBar().setTitle(title);
                    // AURORA-END::add for ActionBar Title::waynelin::2013-9-17
                }
                return;
            }
            if (mSinglePane) {
                ...
                // View bcSection =
                // findViewById(R.id.breadcrumb_section);
    ...
    private void switchToHeaderInner(String fragmentName, Bundle args, int direction) {
        ...
        transaction.replace(R.id.aurora_prefs, f);
    ...
    public void startPreferenceFragment(Fragment fragment, boolean push) {
        FragmentTransaction transaction = getFragmentManager().beginTransaction();
        transaction.replace(R.id.aurora_prefs, fragment);
        if (push) {
...
//    	if(getListView() != null){
//    		((AuroraPreferenceGroupAdapter)getListView().getAdapter()).update();
//    	}
//    }
    ...
    public void setPreferenceScreen(AuroraPreferenceScreen preferenceScreen) {
        ...
        if (mPreferenceManager.setPreferences(preferenceScreen) && preferenceScreen != null) {
            ...
            if (title != null) {
                // setTitle(title);
                // AURORA-START::add for ActionBar Title::waynelin::2013-9-17
                getAuroraActionBar().setTitle(title);
                // AURORA-END::add for ActionBar Title::waynelin::2013-9-17
            }
        }
...
class RefreshPaddingListener implements OnScrollListener {

    public interface Callback {
        void execute(int padding);
    }
