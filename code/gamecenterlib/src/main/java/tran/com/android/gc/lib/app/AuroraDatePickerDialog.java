...
import tran.com.android.gc.lib.widget.AuroraDatePicker;
import tran.com.android.gc.lib.widget.AuroraDatePicker.OnDateChangedListener;
...
//        setView(view);
//        mDatePicker = (AuroraDatePicker) view.findViewById(R.id.aurora_datePicker);
...
//        updateTitle(year, monthOfYear, dayOfMonth);
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	mDatePicker = (AuroraDatePicker)findViewById(R.id.aurora_date_picker);
    	mTitle = (TextView)findViewById(R.id.aurora_date_picker_title);
    	mPositiveButton = (Button)findViewById(R.id.aurora_date_picker_done_button);
    	mNegtiveButton = (Button)findViewById(R.id.aurora_date_picker_cancel_button);
    	
    	mGreyBackground = (ImageView)findViewById(R.id.aurora_date_picker_dialog_grey_bg);
...
//		});
    	View.OnClickListener clickListener = new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				if(v.getId() == R.id.aurora_date_picker_done_button){
//					AuroraDatePickerDialog.
					...
					tryNotifyDateSet();
					dismiss();
				}else if(v.getId() == R.id.aurora_date_picker_cancel_button){
					dismiss();
				}
			}
		};
