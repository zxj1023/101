...
abstract class AuroraGenericInflater<T, P extends AuroraGenericInflater.Parent> {
     ...
     *            retrieved.
     */
    protected AuroraGenericInflater(Context context) {
        mContext = context;
    }
     ...
     */
    protected AuroraGenericInflater(AuroraGenericInflater<T,P> original, Context newContext) {
        mContext = newContext;
     ...
     * the given Context.
     */
    public abstract AuroraGenericInflater cloneInContext(Context newContext);
        ...
        try {
            if (null == constructor) {
                ...
                if (isNativePreferenceClass(name)) {
                    ...
                    NativePreferenceManager.setAnalyzeNativePreferenceXml(true);
                    name = "tran.com.android.gc.lib.preference.Aurora" + name.substring(name.lastIndexOf('.') + 1);
                }else {
    ...
    private boolean isNativePreferenceClass(String name) {
        if (-1 != name.indexOf('.')) {
            return false;
        } else if (name.equals("PreferenceScreen") || name.equals("PreferenceGroup") || name.equals("PreferenceCategory") ||
                name.equals("Preference") || name.equals("PreferenceFragment") || name.equals("CheckBoxPreference") ||
                name.equals("SwitchPreference") || name.equals("DialogPreference") || name.equals("EditTextPreference") ||
                name.equals("ListPreference") || name.equals("MultiCheckPreference") || name.equals("MultiSelectListPreference") ||
                name.equals("RingtonePreference") || name.equals("SeekBarDialogPreference") || name.equals("SeekBarPreference") ||
                name.equals("VolumePreference")) {
            return true;
        }
        return false;
    }
