...
public class AuroraAlertController {
    ...
    public AuroraAlertController(Context context, DialogInterface di, Window window) {
        ...
        mAlertDialogLayout = R.layout.aurora_alert_dialog_internal;
        ...
        mAndroidDialogLayout = R.layout.android_alert_dialog;
    ...
    private void auroraSetupView(){
        LinearLayout contentPanel = (LinearLayout) mWindow
                .findViewById(R.id.aurora_contentPanel);
        setupContent(contentPanel);
        boolean hasButtons = setupButtons();

        LinearLayout topPanel = (LinearLayout) mWindow
                .findViewById(R.id.aurora_topPanel);
...
//            }
    ...
    private boolean setupTitle(LinearLayout topPanel) {
        ...
        if (mCustomTitleView != null) {
            ...
            if (hasTextTitle) {
                ...
                mTitleView = (TextView) mWindow.findViewById(R.id.aurora_alertTitle);
    ...
    private void setAndroidBackground(LinearLayout topPanel, LinearLayout contentPanel,
        ...
        /*
         * R.drawable.aurora_dialog_white_bg We now set the
...
//        int fullDark = R.drawable.aurora_dialog_white_bg;
//        int topDark = R.drawable.aurora_dialog_white_bg;
//        int centerDark = R.drawable.aurora_dialog_white_bg;
//        int bottomDark = R.drawable.aurora_dialog_white_bg;
...
//        
        ...
        /*mFromAlertActivity ||*/
        if(mContext instanceof com.android.internal.app.AlertActivity){
...
//        	Log.e("edit", ""+(!mIsAuroraStyle && !isSystemApp(mContext)
//        			||mIsAuroraStyle &&!isSystemApp(mContext)));
...
//                mListView.setAdapter(mAdapter);
                ...
                if(mAdapter instanceof ArrayAdapter){
                	adapter = mAdapter;//new AuroraListAdapter((ArrayAdapter)mAdapter);
    ...
    private void changeInnerTextColor(View view) {
        ...
        if (view instanceof TextView) {
            if(view instanceof Button){
            	 ((Button)view).setTextColor(mContext.getResources().getColorStateList(R.color.aurora_button_text_color));
            }else{
    ...
    private void setButtonBackground(LinearLayout buttonPanel){
        int oneButtonSrc = R.drawable.aurora_alert_dialog_btn_selector;
...
//        }
    ...
    private int[] auroraChangeToAndroid() {
        ...
        int fullDark = a.getResourceId(
                ...
                R.drawable.aurora_dialog_white_bg);
    ...
    public static class AuroraAlertParams {
        ...
        private void createListView(final AuroraAlertController dialog) {
            int layout = 0;
            int selectDialogSingleChioce = R.layout.aurora_select_dialog_singlechoice_android;
            int listItemLayout = R.layout.aurora_select_dialog_item;
