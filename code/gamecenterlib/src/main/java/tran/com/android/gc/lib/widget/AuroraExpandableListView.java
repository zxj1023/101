...
import tran.com.android.gc.lib.widget.AuroraExpandableListConnector.PositionMetadata;
 ...
 */
public class AuroraExpandableListView extends AuroraListView {
    ...
    private AuroraExpandableListConnector mConnector;
    ...
    public AuroraExpandableListView(Context context) {
        this(context, null);
    }

    public AuroraExpandableListView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.auroraExpandableListViewStyle);
    }

    public AuroraExpandableListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        mContext = context;
        
        TypedArray a =
            context.obtainStyledAttributes(attrs, R.styleable.AuroraExpandableListView, defStyle,
                    0);

        mGroupIndicator = a
                .getDrawable(R.styleable.AuroraExpandableListView_auroragroupIndicator);
        mChildIndicator = a
                .getDrawable(R.styleable.AuroraExpandableListView_aurorachildIndicator);
        mIndicatorLeft = a
                .getDimensionPixelSize(R.styleable.AuroraExpandableListView_auroraindicatorLeft, 0);
        mIndicatorRight = a
                .getDimensionPixelSize(R.styleable.AuroraExpandableListView_auroraindicatorRight, 0);
        if (mIndicatorRight == 0 && mGroupIndicator != null) {
            mIndicatorRight = mIndicatorLeft + mGroupIndicator.getIntrinsicWidth();
        }
        mChildIndicatorLeft = a.getDimensionPixelSize(
                R.styleable.AuroraExpandableListView_aurorachildIndicatorLeft, CHILD_INDICATOR_INHERIT);
        mChildIndicatorRight = a.getDimensionPixelSize(
                R.styleable.AuroraExpandableListView_aurorachildIndicatorRight, CHILD_INDICATOR_INHERIT);
        mChildDivider = a.getDrawable(R.styleable.AuroraExpandableListView_aurorachildDivider);
        
        Drawable draw = context.getResources().getDrawable(R.drawable.aurora_transparent);
        setChildDivider(draw);
        // setSelector(R.drawable.aurora_transparent);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int lastItemType = ~(AuroraExpandableListPosition.CHILD | AuroraExpandableListPosition.GROUP);
        ...
        for (int i = 0, childFlPos = getFirstVisiblePosition() - headerViewsCount; i < childCount;
            ...
            if (pos.position.type != lastItemType) {
                if (pos.position.type == AuroraExpandableListPosition.CHILD) {
    ...
    private Drawable getIndicator(PositionMetadata pos) {
        ...
        if (pos.position.type == AuroraExpandableListPosition.GROUP) {
    ...
    void drawDivider(Canvas canvas, Rect bounds, int childIndex) {
        ...
        if (flatListPosition >= 0) {
            ...
            if ((pos.position.type == AuroraExpandableListPosition.CHILD) || (pos.isExpanded() &&
                    pos.groupMetadata.lastChildFlPos != pos.groupMetadata.flPos)) {
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        if (adapter != null) {
            ...
            mConnector = new AuroraExpandableListConnector(mContext, adapter);
        } else {
            mConnector = null;
        }
    ...
    boolean handleItemClick(View v, int position, long id) {
        ...
        mConnector.setExpandAnimFlg(false);
        
        boolean returnValue;
        if (posMetadata.position.type == AuroraExpandableListPosition.GROUP) {
            ...
            if (posMetadata.isExpanded()) {
            	...
            	mConnector.setExpandAnimFlg(true);
                /* Expand it */
    ...
    public boolean expandGroup(int groupPos, boolean animate) {
        AuroraExpandableListPosition elGroupPos = AuroraExpandableListPosition.obtain(
                AuroraExpandableListPosition.GROUP, groupPos, -1, -1);
    ...
    public interface OnGroupClickListener {
         ...
         */
        boolean onGroupClick(AuroraExpandableListView parent, View v, int groupPosition,
                long id);
    }
    ...
    public interface OnChildClickListener {
         ...
         * @return True if the click was handled
         */
        boolean onChildClick(AuroraExpandableListView parent, View v, int groupPosition,
    ...
    public int getFlatListPosition(long packedPosition) {
        AuroraExpandableListPosition elPackedPos = AuroraExpandableListPosition
    ...
    public void setSelectedGroup(int groupPosition) {
        AuroraExpandableListPosition elGroupPos = AuroraExpandableListPosition
    ...
    public boolean setSelectedChild(int groupPosition, int childPosition, boolean shouldExpandGroup) {
        AuroraExpandableListPosition elChildPos = AuroraExpandableListPosition.obtainChildPosition(
    ...
    ContextMenuInfo createContextMenuInfo(View view, int flatListPosition, long id) {
        ...
        final int adjustedPosition = getFlatPositionForConnector(flatListPosition);
        PositionMetadata pm = mConnector.getUnflattenedPos(adjustedPosition);
        AuroraExpandableListPosition pos = pm.position;
     ...
     *            returned.
     */
    private long getChildOrGroupId(AuroraExpandableListPosition position) {
        if (position.type == AuroraExpandableListPosition.CHILD) {
    ...
    static class SavedState extends BaseSavedState {
        ArrayList<AuroraExpandableListConnector.GroupMetadata> expandedGroupMetadataList;
        ...
        private SavedState(Parcel in) {
            super(in);
            expandedGroupMetadataList = new ArrayList<AuroraExpandableListConnector.GroupMetadata>();
            in.readList(expandedGroupMetadataList, AuroraExpandableListConnector.class.getClassLoader());
        }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(AuroraExpandableListView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(AuroraExpandableListView.class.getName());
    }
    

    private Context mContext;
    
    private void startCollapseGroupAnimation(final PositionMetadata posMetadata) {
    	Log.v("GnExpandListView", "startCollapseGroupAnimation");
		// TODO Auto-generated method stub
    	collapseAnimation(posMetadata);
	}
	
	public void collapseAnimation(final PositionMetadata posMetadata) {
    	int firstChildPos = posMetadata.groupMetadata.flPos + 1;
    	int lastChildPos =  posMetadata.groupMetadata.lastChildFlPos;
    	
    	Log.v("GnExpandListView", "animateDismiss firstChildPos " + firstChildPos + " lastChildPos " + lastChildPos);
    	List<View> views = new ArrayList<View>();
    	for (int j = lastChildPos; j > firstChildPos - 1; j--) {
    		views.add(getChildAt(j));
    	}
		...
		if (!views.isEmpty()) {
			...
			for (final View view : views) {
				if (view != null) {
					animators.add(createcollapseAnimatorForView(view));
					/*animators.add(createAlphaAnimaForView(view));*/
				}
			}
			...
			animatorSet.addListener(new AnimatorListener() {
				...
				public void onAnimationEnd(Animator arg0) {
			    	Log.v("GnExpandListView", "animateDismiss onAnimationEnd");
	...
	private Animator createcollapseAnimatorForView(final View view) {
    	...
    	Log.v("GnExpandListView", "createcollapseAnimatorForView originalHeight" + originalHeight);
		...
		animator.addListener(new AnimatorListener() {
			...
			@Override
			public void onAnimationEnd(Animator arg0) {
		    	Log.v("GnExpandListView", "createcollapseAnimatorForView onAnimationEnd");
				lp.height = 0;
		...
		animator.addUpdateListener(new AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator valueAnimator) {
				...
				Log.v("GnExpandListView", "createcollapseAnimatorForView onAnimationUpdate lp.height = " + lp.height);
				view.setLayoutParams(lp);
			}
		});
	...
	/*private Animator createAlphaAnimaForView(View view) {
	...
	private void startCollapseGroup(PositionMetadata posMetadata) {
    	Log.v("GnExpandListView", "startCollapseGroup");
