...
public class AuroraSwitch extends CompoundButton {
	...
	private int[] auroraDrawableIds = {
				 R.drawable.switch0001,R.drawable.switch0002,R.drawable.switch0003
	...
	private int[] auroraDrawableOffIds = {
				 R.drawable.switch0070,R.drawable.switch0071,R.drawable.switch0072
    			,R.drawable.switch0073,R.drawable.switch0074,R.drawable.switch0075
    			,R.drawable.switch0076,R.drawable.switch0077,R.drawable.switch0078
    			,R.drawable.switch0079,R.drawable.switch0080,R.drawable.switch0081
    			,R.drawable.switch0082,R.drawable.switch0083,R.drawable.switch0084
    			,R.drawable.switch0085,R.drawable.switch0086,R.drawable.switch0087
    			,R.drawable.switch0088,R.drawable.switch0089,R.drawable.switch0090
    			,R.drawable.switch0091,R.drawable.switch0092,R.drawable.switch0093
    			,R.drawable.switch0094,R.drawable.switch0095,R.drawable.switch0096
    			,R.drawable.switch0097,R.drawable.switch0098,R.drawable.switch0099
    			,R.drawable.switch0100
	};
    ...
    public AuroraSwitch(Context context, AttributeSet attrs, int defStyle) {
        ...
        vaoff.addUpdateListener(new AnimatorUpdateListener(){
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				...
				log("vaoff onAnimationUpdate  value = "+ (Integer)animation.getAnimatedValue());
				setTrackResource(auroraDrawableOffIds[(Integer)animation.getAnimatedValue()]);
				invalidate();
			}
       ...
       /*
    	 vaon = ValueAnimator.ofInt(R.drawable.switch0001,R.drawable.switch0002,R.drawable.switch0003
    			,R.drawable.switch0004,R.drawable.switch0005,R.drawable.switch0006
    			,R.drawable.switch0007,R.drawable.switch0008,R.drawable.switch0009
    			,R.drawable.switch0010,R.drawable.switch0011,R.drawable.switch0012
    			,R.drawable.switch0013,R.drawable.switch0014,R.drawable.switch0015
		...
		*/
        ...
        vaon.addUpdateListener(new AnimatorUpdateListener(){
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				// TODO Auto-generated method stub
				log("vaon onAnimationUpdate  value = "+ (Integer)animation.getAnimatedValue());
				
				setTrackResource(auroraDrawableIds[(Integer)animation.getAnimatedValue()]);
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        colors = appearance.getColorStateList(android.R.styleable.TextAppearance_textColor);
        if (colors != null) {
            mTextColors = colors;
        } else {
        ...
        ts = appearance.getDimensionPixelSize(android.R.styleable.TextAppearance_textSize, 0);
        if (ts != 0) {
...
//        mThumbDrawable.getPadding(mTempRect);
	...
	private void auroraStartDraggingRemainderAnim(int start,int end,boolean changeValue)
	{
		final int[] ids = isChecked()?auroraDrawableOffIds:auroraDrawableIds;
		...
		auroraDragAnim.addUpdateListener(new AnimatorUpdateListener(){
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				// TODO Auto-generated method stub
				log("auroraDragAnim onAnimationUpdate  value = "+ (Integer)animation.getAnimatedValue());
        ...
        auroraDragAnim.addListener(new AnimatorListener(){
			...
			public void onAnimationEnd(Animator animation) {
				...
				if(changedVaule)
				{
					log("auroraDragAnim onAnimationEnd  changedVaule = "+ changedVaule);
    ...
    private void doAnimation() {
        ...
        mAnimationPosition += mAnimatedVelocity * FrameAnimationControllerNew.ANIMATION_FRAME_DURATION
                / 1000;
        mThumbPosition = isChecked() ? 0:getThumbScrollRange();
        
         log("liuwei","mAnimationPosition = " + mAnimationPosition + "mAnimatedVelocity = " + mAnimatedVelocity + "getThumbScrollRange() = "+getThumbScrollRange());
    ...
    public void setChecked(boolean checked) {
		...
		if(auroraAnimIsPlayingOpenAnim())vaon.cancel();
		
		if(auroraAnimIsPlayingCloseAnim())vaoff.cancel();
...
//        }
	...
	private void auroraPlayClickSound()
	{
		...
		{
			auroraSoundPool.play(auroraSoundId, leftVolume, rightVolume, priority, root, rate);
		}
	}
	...
	private boolean auroraIsSoundEffectEnable()
	{
		...
		try {
			...
			enable = Settings.System.getInt(getContext().getContentResolver(), Settings.System.SOUND_EFFECTS_ENABLED);
