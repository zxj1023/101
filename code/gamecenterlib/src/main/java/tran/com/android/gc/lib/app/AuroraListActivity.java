...
public class AuroraListActivity extends AuroraActivity {
	/**
	 ...
	 * }
	 */
	protected AuroraListView mList;
	 ...
	 * 
	 * @param l
	 *            The AuroraListView where the click happened
	 * @param v
	 *            The view that was clicked within the AuroraListView
	 * @param position
	 *            The position of the view in the list
	 * @param id
	 *            The row id of the item that was clicked
	 */
	protected void onListItemClick(AuroraListView l, View v, int position,
			long id) {
	}
	...
	public void onContentChanged() {
		...
		if (getAuroraActionBarHost() == null)
			return;
		View emptyView = findViewById(android.R.id.empty);
		mList = (AuroraListView) findViewById(android.R.id.list);
		if (mList == null) {
	...
	/**
	 * Get the ListAdapter associated with this activity's AuroraListView.
	 */
	...
	private void ensureList() {
		...
		// setContentView(R.layout.aurora_list_content_simple);
		setAuroraContentView(R.layout.aurora_list_content_simple);
	}

	private AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View v, int position,
				long id) {
			onListItemClick((AuroraListView) parent, v, position, id);
		}
	};
